...
def derive_wallets(coin):
    command = f'~/./derive -g --mnemonic="fiscal behave wealth immune spawn position pigeon exile snow tomato try member\
...
# key = wif_to_key("c9ee5e8c7f56770d4fba611047319cd9b5a60e40bfed127f49d18b19a351797c")

# # replace with different addresses
# addresses = ["0x01b9336fB302743B539cDbD1df7a89202Ccb1FbC", "1GYDqtCygQE2x9k7jNdcESuHUnyVfFZmku"]

# output = []

# for address in addresses:
#     output.append((address, 0.0001, "btc"))
...
print(eth_test_key)
#print(coins[BTCTEST][0]['privkey']) #the objective is to obtain 1 private key from both ETH and BTC and then invoke/
